...
if(isset($_GET["count"])) {
   ...
   $sql3 = "SELECT * FROM tbl_history WHERE Date = '$date2' AND ID = 8";
   $result = $conn->query($sql3);
   
   if ($result->num_rows > 0) {	    
		echo "Upd! ";
		$sql2 = "UPDATE tbl_history SET Count = ($count) WHERE ID = 8 AND Date = '$date2'";
   }
   else {
	   echo "New! ";
		$sql2 = "INSERT into tbl_history (Date, ID, Count) VALUES ('$date2', 8, ($count))"; 
   }
