...
const char WIFI_SSID[] = "TP-LINK_AP_1428_Office";  //U cetak dor com 2.4@unifi
const char WIFI_PASSWORD[] = "95415789"; //lavender4
String HOST_NAME = "http://192.168.0.100"; // change to your PC's IP address
//http://192.168.0.101/update_count.php?count=138
String UPDATE_NAME   = "/update_count2.php";
String queryString = "?count=";
String t;

unsigned long previousMillis = 0;  
const long interval = 5000;
int count, p, n, flag, dis, dis2, dis3, bs, lbs, bs2, lbs2, bs3, lbs3, flagD, limit;
bool x;
